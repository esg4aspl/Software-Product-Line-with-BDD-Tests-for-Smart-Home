Feature: internetAndPrivacyAndRSA1
Background: Setup
Given The environment is set up with "Turn on,UI output,Internet input,Encrypt input with RSA,Send private input message,Decrypt input with RSA,Internet output,Encrypt output with RSA,Send private output message,Decrypt output with RSA,UI output,Turn off"
