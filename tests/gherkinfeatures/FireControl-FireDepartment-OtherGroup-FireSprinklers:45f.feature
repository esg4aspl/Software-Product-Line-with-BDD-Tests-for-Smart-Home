Feature: FireControl-FireDepartment-OtherGroup-FireSprinklers:45
Background: Setup
Given The environment is set up with "turn on,output to console,fire detected via smoke detector,call fire department,turn on siren,call other group for fire,open fire sprinklers,close fire sprinklers"
When Feature name is "FireControl-FireDepartment-OtherGroup-FireSprinklers:45"
