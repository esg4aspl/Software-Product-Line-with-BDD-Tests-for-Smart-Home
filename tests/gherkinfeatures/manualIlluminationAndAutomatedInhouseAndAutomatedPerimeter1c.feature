Feature: manualIlluminationAndAutomatedInhouseAndAutomatedPerimeter1
Background: Setup
Given The environment is set up with "Turn on,UI output,Automated inhouse light on,UI output,Automated inhouse light off,UI output,Automated perimeter light on,UI output,Automated perimeter light off,UI output,Manual light on,UI output,Manual light off,UI output,Turn off"
